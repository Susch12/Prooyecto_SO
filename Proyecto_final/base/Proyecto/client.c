...
int main() {
    ...
    int flag = 1; // 1 para deshabilitar Nagle
    if (setsockopt(client_socket, IPPROTO_TCP, TCP_NODELAY, (void *)&flag, sizeof(flag)) < 0) {
        error("Error deshabilitando el algoritmo de Nagle");
    }
